...
import { StyleSheet, ScrollView, View, Text, TouchableOpacity, Image, Dimensions ,Clipboard} from 'react-native';
...
class noCategory extends Component {
    ...
    render() {
        ...
        return(
            ...
            <View style={{height:"100%",display:this.state.display,backgroundColor:"#afccc3"}}> 
                     <Text style={{color:"white",alignSelf:"center",top:0.45*height,fontSize:24,fontFamily:'Cairo-Regular'}}>
                         Copied
                     </Text>
                 </View>
            <ScrollView >
